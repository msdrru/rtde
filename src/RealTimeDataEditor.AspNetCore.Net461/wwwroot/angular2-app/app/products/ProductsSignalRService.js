...
var ProductsSignalRService = (function () {
    function ProductsSignalRService() {
    ...
    ProductsSignalRService.prototype.sendChatMessage = function (message) {
    ...
    ProductsSignalRService.prototype.registerOnServerEvents = function () {
        var _this = this;
        this.proxy.on('HandleProductMessage', function (data) {
            _this.productChanged.emit(data);
        });
    };
...
//# sourceMappingURL=productsSignalRService.js.map